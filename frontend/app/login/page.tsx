    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative max-w-md w-full space-y-6 sm:space-y-8">
        ...
        >
          ...
          <div className="flex p-1 bg-gray-800/50 rounded-xl sm:rounded-2xl mb-6 sm:mb-8">
            <button
              onClick={() => setIsSignUp(false)}
              className={`flex-1 py-3 sm:py-4 px-4 rounded-lg sm:rounded-xl text-sm font-medium transition-all duration-300 touch-manipulation ${
                !isSignUp 
          ...
          <form onSubmit={handleAuth} className="space-y-6">
            <div className="space-y-4 sm:space-y-5">
              <div>
                ...
                <motion.input
                  ...
                  className="w-full px-4 py-4 bg-gray-800/50 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-300 text-base touch-manipulation"
            ...
            {!isSignUp && (
              <div className="text-center">
                <button
                  type="button"
                  className="text-amber-400 hover:text-amber-300 text-sm font-medium transition-colors duration-300 py-2 px-4 touch-manipulation"
                >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <motion.button
              ...
              className="group flex items-center justify-center px-4 py-4 border border-gray-600 rounded-xl bg-gray-800/50 hover:bg-gray-700/50 text-gray-300 hover:text-white transition-all duration-300 touch-manipulation"
        ...
        >
          <p className="text-gray-400 text-sm">
            ...
            <button
              ...
              className="text-amber-400 hover:text-amber-300 font-medium transition-colors duration-300 py-2 px-2 touch-manipulation"
            >
